...
tune_folder="/home/gaudu/pyapprentice-1.1.0/bin/tune/"
...
for ((i=0; i<$folders; i++)); do
    ...
    cp main1009_tune_"$formatted_i"_10000.yoda $tune_folder/$formatted_i/main1009_tune_"$formatted_i"_10000.yoda
done